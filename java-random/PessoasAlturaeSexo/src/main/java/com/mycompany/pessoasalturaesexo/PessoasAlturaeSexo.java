package com.mycompany.pessoasalturaesexo;

import java.util.Scanner;

public class PessoasAlturaeSexo {
    ...
    public static void main(String[] args) {
        ...
        for (int i=0; i<10; i++) {
            System.out.println("Nº da escolha é: " + i );
            System.out.println("Escolhe o sexo da pessoa (1-Mulher, 2-Homem): ");
            sexo = entrada.nextInt();
            System.out.println("Define a altura: ");
